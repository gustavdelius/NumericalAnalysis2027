...
1. Use your `gradient_descent_1d()` function from @exr-3.53 to calculate the list of iterates, and from that the list of absolute errors between the iterates and the exact minimum, as you did for Newton's method in @exr-newton_error_tracking. 
