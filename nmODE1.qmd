...
6. 🎓 Complete the following code to make a plot that shows both position and velocity versus time.
...
7. Complete the following code to make a second plot, called a phase plot, that shows position versus velocity. In a phase plot, time is implicit (not one of the axes).
