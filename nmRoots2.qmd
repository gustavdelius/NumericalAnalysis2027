...
💻 🎓 Because your `newton()` function from @exr-2.38 returns the list of all iterates, you can calculate the absolute errors between the iterates and the exact solution from that list, just as we did for the bisection method in @exm-2.1.
...
::: {#exr-2.50}
💻 Calculate the absolute errors between the iterates returned by your secant function from @exr-2.49 and the exact solution, as we did for the bisection method in @exm-2.1.
