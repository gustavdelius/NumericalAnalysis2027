...
``` python         
names_list = ['Alice','Billy','Charlie','Dom','Enrique','Francisco']
...
``` python         
# create a list of the perfect squares from 1 to 9
cool_list = [x**2 for x in range(1,10)]
print(cool_list)
# Then print the sum of this list
print("The sum of the first 9 perfect squares is", sum(cool_list))
```
