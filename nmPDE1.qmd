...
Check that your function works by using it to calculate the same solution as in @exr-9.2 and plotting the solution with `plot_solution_1d()` or `animate_solution_1d()`.
