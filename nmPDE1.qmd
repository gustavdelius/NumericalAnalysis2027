...
To judge whether a solution is stable, look at the plot of the solution at the final time step. An instability shows up there as a sawtooth pattern, alternating in sign from one grid point to the next, that is not present in the true solution and that grows as you run the simulation for longer. This is much easier to see than in a plot of the solution over the entire time range.
