...
def plot_error_progression(errors):
    """
    Plot the base-2 logarithm of the absolute error at step n+1 against
    that at step n, together with a best fit line.
...
def fixed_point_iteration():
    """
    Perform 10 iterations of the fixed-point iteration x_n = g(x_{n-1}),
    starting from x_0 = 1.0, and return the final iterate.
    """
    x = 1.0
    for i in range(...):
        x = ...
